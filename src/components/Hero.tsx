...
export const Hero = () => {
  return (
    <section className="relative pb-24 rounded-b-3xl z-30 bg-white">
      <div className="relative mx-4 sm:mx-16 overflow-hidden mt-4">
        <video
          ...
          loop
        />
        <div className="absolute top-0 left-0 w-full h-full bg-black/60 rounded-3xl" />
