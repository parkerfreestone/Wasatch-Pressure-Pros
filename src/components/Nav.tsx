    ...
    >
      ...
      >
        ...
        <div className="hidden xl:flex gap-5 flex-1 justify-end items-center">
          ...
          >
            <a href="tel:801-675-9064">(801) 675-9064</a>
            <Phone />
          </div>
          <a
      ...
      >
        ...
        <div className="flex gap-4 justify-between w-full mt-10">
          <div className="flex justify-center items-center flex-1 gap-2 border border-zinc-800 px-4 py-2 rounded-full transition-all text-zinc-800 hover:bg-zinc-800 hover:text-zinc-50">
            <a href="tel:801-675-9064">(801) 675-9064</a>
            <Phone />
          </div>
          <a
